...
#line 29 "/home/pi/PyQt5_gpl-5.10.1/QtWidgets/sipQtWidgetsQScrollerProperties.cpp"

#line 26 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 33 "/home/pi/PyQt5_gpl-5.10.1/QtWidgets/sipQtWidgetsQScrollerProperties.cpp"
...
static sipEnumMemberDef enummembers_QScrollerProperties[] = {
    {sipName_AcceleratingFlickMaximumTime, static_cast<int>( ::QScrollerProperties::AcceleratingFlickMaximumTime), 266},
    {sipName_AcceleratingFlickSpeedupFactor, static_cast<int>( ::QScrollerProperties::AcceleratingFlickSpeedupFactor), 266},
    {sipName_AxisLockThreshold, static_cast<int>( ::QScrollerProperties::AxisLockThreshold), 266},
    {sipName_DecelerationFactor, static_cast<int>( ::QScrollerProperties::DecelerationFactor), 266},
    {sipName_DragStartDistance, static_cast<int>( ::QScrollerProperties::DragStartDistance), 266},
    {sipName_DragVelocitySmoothingFactor, static_cast<int>( ::QScrollerProperties::DragVelocitySmoothingFactor), 266},
    {sipName_Fps20, static_cast<int>( ::QScrollerProperties::Fps20), 264},
    {sipName_Fps30, static_cast<int>( ::QScrollerProperties::Fps30), 264},
    {sipName_Fps60, static_cast<int>( ::QScrollerProperties::Fps60), 264},
    {sipName_FrameRate, static_cast<int>( ::QScrollerProperties::FrameRate), 266},
    {sipName_HorizontalOvershootPolicy, static_cast<int>( ::QScrollerProperties::HorizontalOvershootPolicy), 266},
    {sipName_MaximumClickThroughVelocity, static_cast<int>( ::QScrollerProperties::MaximumClickThroughVelocity), 266},
    {sipName_MaximumVelocity, static_cast<int>( ::QScrollerProperties::MaximumVelocity), 266},
    {sipName_MinimumVelocity, static_cast<int>( ::QScrollerProperties::MinimumVelocity), 266},
    {sipName_MousePressEventDelay, static_cast<int>( ::QScrollerProperties::MousePressEventDelay), 266},
    {sipName_OvershootAlwaysOff, static_cast<int>( ::QScrollerProperties::OvershootAlwaysOff), 265},
    {sipName_OvershootAlwaysOn, static_cast<int>( ::QScrollerProperties::OvershootAlwaysOn), 265},
    {sipName_OvershootDragDistanceFactor, static_cast<int>( ::QScrollerProperties::OvershootDragDistanceFactor), 266},
    {sipName_OvershootDragResistanceFactor, static_cast<int>( ::QScrollerProperties::OvershootDragResistanceFactor), 266},
    {sipName_OvershootScrollDistanceFactor, static_cast<int>( ::QScrollerProperties::OvershootScrollDistanceFactor), 266},
    {sipName_OvershootScrollTime, static_cast<int>( ::QScrollerProperties::OvershootScrollTime), 266},
    {sipName_OvershootWhenScrollable, static_cast<int>( ::QScrollerProperties::OvershootWhenScrollable), 265},
    {sipName_ScrollMetricCount, static_cast<int>( ::QScrollerProperties::ScrollMetricCount), 266},
    {sipName_ScrollingCurve, static_cast<int>( ::QScrollerProperties::ScrollingCurve), 266},
    {sipName_SnapPositionRatio, static_cast<int>( ::QScrollerProperties::SnapPositionRatio), 266},
    {sipName_SnapTime, static_cast<int>( ::QScrollerProperties::SnapTime), 266},
    {sipName_Standard, static_cast<int>( ::QScrollerProperties::Standard), 264},
    {sipName_VerticalOvershootPolicy, static_cast<int>( ::QScrollerProperties::VerticalOvershootPolicy), 266},
};
