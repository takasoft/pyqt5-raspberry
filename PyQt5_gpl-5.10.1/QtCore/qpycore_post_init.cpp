...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-t WS_X11 -t Qt_5_7_1 -x PyQt_Desktop_OpenGL");
#else
    PyObject *sip_flags = PyString_FromString("-t WS_X11 -t Qt_5_7_1 -x PyQt_Desktop_OpenGL");
#endif
