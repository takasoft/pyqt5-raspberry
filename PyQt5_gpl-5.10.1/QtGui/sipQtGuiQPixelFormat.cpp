...
#line 29 "/home/pi/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQPixelFormat.cpp"
...
static sipEnumMemberDef enummembers_QPixelFormat[] = {
    {sipName_Alpha, static_cast<int>( ::QPixelFormat::Alpha), 223},
    {sipName_AtBeginning, static_cast<int>( ::QPixelFormat::AtBeginning), 219},
    {sipName_AtEnd, static_cast<int>( ::QPixelFormat::AtEnd), 219},
    {sipName_BGR, static_cast<int>( ::QPixelFormat::BGR), 223},
    {sipName_BigEndian, static_cast<int>( ::QPixelFormat::BigEndian), 222},
    {sipName_CMYK, static_cast<int>( ::QPixelFormat::CMYK), 223},
    {sipName_CurrentSystemEndian, static_cast<int>( ::QPixelFormat::CurrentSystemEndian), 222},
    {sipName_FloatingPoint, static_cast<int>( ::QPixelFormat::FloatingPoint), 224},
    {sipName_Grayscale, static_cast<int>( ::QPixelFormat::Grayscale), 223},
    {sipName_HSL, static_cast<int>( ::QPixelFormat::HSL), 223},
    {sipName_HSV, static_cast<int>( ::QPixelFormat::HSV), 223},
    {sipName_IMC1, static_cast<int>( ::QPixelFormat::IMC1), 225},
    {sipName_IMC2, static_cast<int>( ::QPixelFormat::IMC2), 225},
    {sipName_IMC3, static_cast<int>( ::QPixelFormat::IMC3), 225},
    {sipName_IMC4, static_cast<int>( ::QPixelFormat::IMC4), 225},
    {sipName_IgnoresAlpha, static_cast<int>( ::QPixelFormat::IgnoresAlpha), 221},
    {sipName_Indexed, static_cast<int>( ::QPixelFormat::Indexed), 223},
    {sipName_LittleEndian, static_cast<int>( ::QPixelFormat::LittleEndian), 222},
    {sipName_NV12, static_cast<int>( ::QPixelFormat::NV12), 225},
    {sipName_NV21, static_cast<int>( ::QPixelFormat::NV21), 225},
    {sipName_NotPremultiplied, static_cast<int>( ::QPixelFormat::NotPremultiplied), 220},
    {sipName_Premultiplied, static_cast<int>( ::QPixelFormat::Premultiplied), 220},
    {sipName_RGB, static_cast<int>( ::QPixelFormat::RGB), 223},
    {sipName_UYVY, static_cast<int>( ::QPixelFormat::UYVY), 225},
    {sipName_UnsignedByte, static_cast<int>( ::QPixelFormat::UnsignedByte), 224},
    {sipName_UnsignedInteger, static_cast<int>( ::QPixelFormat::UnsignedInteger), 224},
    {sipName_UnsignedShort, static_cast<int>( ::QPixelFormat::UnsignedShort), 224},
    {sipName_UsesAlpha, static_cast<int>( ::QPixelFormat::UsesAlpha), 221},
    {sipName_Y16, static_cast<int>( ::QPixelFormat::Y16), 225},
    {sipName_Y8, static_cast<int>( ::QPixelFormat::Y8), 225},
    {sipName_YUV, static_cast<int>( ::QPixelFormat::YUV), 223},
    {sipName_YUV411, static_cast<int>( ::QPixelFormat::YUV411), 225},
    {sipName_YUV420P, static_cast<int>( ::QPixelFormat::YUV420P), 225},
    {sipName_YUV420SP, static_cast<int>( ::QPixelFormat::YUV420SP), 225},
    {sipName_YUV422, static_cast<int>( ::QPixelFormat::YUV422), 225},
    {sipName_YUV444, static_cast<int>( ::QPixelFormat::YUV444), 225},
    {sipName_YUYV, static_cast<int>( ::QPixelFormat::YUYV), 225},
    {sipName_YV12, static_cast<int>( ::QPixelFormat::YV12), 225},
};
