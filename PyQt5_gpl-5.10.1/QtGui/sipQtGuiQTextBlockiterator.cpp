...
#include <qtextobject.h>
#line 31 "/home/pi/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQTextBlockiterator.cpp"

#line 233 "/home/pi/PyQt5_gpl-5.10.1/sip/QtGui/qtextobject.sip"
#include <qtextobject.h>
#line 35 "/home/pi/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQTextBlockiterator.cpp"
...
static PyObject *slot_QTextBlock_iterator___isub__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        {
#line 174 "/home/pi/PyQt5_gpl-5.10.1/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)--;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)++;
#line 122 "/home/pi/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQTextBlockiterator.cpp"
...
static PyObject *slot_QTextBlock_iterator___iadd__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1i", &a0))
        {
#line 164 "/home/pi/PyQt5_gpl-5.10.1/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)++;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)--;
#line 169 "/home/pi/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQTextBlockiterator.cpp"
